...
ppo(env_fn=envFunc, ac_kwargs=ac_kwargs, seed= 0 ,max_ep_len=400, steps_per_epoch=4000, epochs=375, logger_kwargs=logger_kwargs)
logger_kwargs = dict(output_dir='/home/isra/Documents/airsim_exp_results_seed_5',exp_name='airsim_fixed_goal')
ppo(env_fn=envFunc, ac_kwargs=ac_kwargs, seed= 5 ,max_ep_len=400, steps_per_epoch=4000, epochs=375, logger_kwargs=logger_kwargs)
logger_kwargs = dict(output_dir='/home/isra/Documents/airsim_exp_results_seed_10',exp_name='airsim_fixed_goal')
ppo(env_fn=envFunc, ac_kwargs=ac_kwargs, seed= 10 ,max_ep_len=400, steps_per_epoch=4000, epochs=375, logger_kwargs=logger_kwargs)
